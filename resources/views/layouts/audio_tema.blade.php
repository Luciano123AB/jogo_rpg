...
<div class="d-flex justify-content-between mb-2">
    <a href="{{ route("musica") }}" class="cursor sombra botoes btn {{ session("tema") == "escuro" ? "btn-secondary" : "btn-dark" }} border {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }} rounded-circle ms-3 px-3 py-2">
    ...
    <a href="{{ route("tema") }}" class="cursor sombra botoes btn {{ session("tema") == "escuro" ? "btn-secondary" : "btn-dark" }} border {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }} rounded-circle me-3 px-3 py-2">
