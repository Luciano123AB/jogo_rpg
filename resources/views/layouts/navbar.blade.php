<nav id="navbar" class="navbar navbar-expand-lg {{ session("tema") == "escuro" ? "bg-light" : "bg-black" }} border-5 border-danger rounded-bottom-5 mb-4">
    <div class="container-fluid">
        ...
        @if($pagina != "Home")
            <a href="{{ route("home") }}" class="cursor sombra botoes btn btn-lg {{ session("tema") == "escuro" ? "btn-secondary" : "btn-dark" }} d-flex border border-danger focus-ring focus-ring-danger my-1">
        ...
        <div class="d-flex gap-3 my-1">
            <button class="cursor sombra botoes btn btn-lg {{ session("tema") == "escuro" ? "btn-secondary" : "btn-dark" }} d-flex border border-danger focus-ring focus-ring-danger">
