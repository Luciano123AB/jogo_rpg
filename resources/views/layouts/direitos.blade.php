@if($pagina == "Home")
    <footer class="position-absolute bottom-0 start-50 translate-middle-x {{ session("tema") == "escuro" ? "bg-light" : "bg-black" }} rounded-2 border {{ session("tema") == "escuro" ? "border-primary" : "border-danger" }} text-center shadow mb-5">
