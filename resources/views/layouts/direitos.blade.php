@if($pagina == "Home")
    <footer class="animate__animated animate__fadeIn position-absolute bottom-0 start-50 translate-middle-x {{ session("tema") == "escuro" ? "bg-light border-primary" : "bg-black border-danger" }} rounded-2 border text-center shadow mb-5">
