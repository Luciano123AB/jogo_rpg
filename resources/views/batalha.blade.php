                ...
                <div class="d-grid gap-2 w-50 mx-auto">
                    ...
                    <form action="{{ route("atacar") }}" method="POST" class="d-grid gap-2" novalidate>
                        ...
                        <div class="btn-group animate__animated animate__fadeIn" role="group" aria-label="SkillsPlayer">
                            ...
                            <label class="cursor d-grid btn {{ session("tema") == "escuro" ? "cor_fontes_escuro bg-secondary btn-outline-primary" : "cor_fontes_claro bg-dark btn-outline-danger" }}" for="btnradio1">🕹 <span>{{ session("player.personagem.skill01.skill") }}</span></label>
                            ...
                            <label class="cursor d-grid btn {{ session("tema") == "escuro" ? "cor_fontes_escuro bg-secondary btn-outline-primary" : "cor_fontes_claro bg-dark btn-outline-danger" }}" for="btnradio2">🕹 <span>{{ session("player.personagem.skill02.skill") }}</span></label>
                            ...
                            <label class="cursor d-grid btn {{ session("tema") == "escuro" ? "cor_fontes_escuro bg-secondary btn-outline-primary" : "cor_fontes_claro bg-dark btn-outline-danger" }}" for="btnradio3">🕹 <span>{{ session("player.personagem.skill03.skill") }}</span></label>
                        </div>
                        @error("skill")
