    ...
    <div class="container text-center w-50">
        <div class="fundo_card card p-3">
            <div class="animate__animated animate__fadeInDown d-grid gap-3">
                ...
                <a href="{{ route("sobre") }}" class="cursor botoes btn btn-lg btn-dark border border-3 border-danger focus-ring focus-ring-danger"><span class="cursor cor_fonte"><i class="cursor bi bi-person-lines-fill"></i> Sobre as Classes</span></a>
