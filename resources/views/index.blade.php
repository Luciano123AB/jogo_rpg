...
@section("content")
    <div class="container text-center w-50">
        <div id="card" class="card d-grid gap-3 p-3">
            ...
            <button class="botoes btn btn-lg btn-dark border border-3 border-danger focus-ring focus-ring-danger"><span class="cor_fonte"><i class="bi bi-person-lines-fill"></i> Sobre as Classes</span></button>
